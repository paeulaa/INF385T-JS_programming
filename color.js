...
function toggleTextColor() {
    ...
    if (currentColorh1 === 'white' || currentColorh2 === 'white' || currentColorContent === 'white') {
        currentColorh1.style.color = 'white';
        currentColorh2.style.color = 'white';
        currentColorContent.style.color = 'white';
    } 
    else if (currentColorh1 === 'black' || currentColorh2 === 'black' || currentColorContent === 'black') {
...
document.getElementById('toggleColorButton').addEventListener('click', toggleTextColor);


// Adding click event listener to the button
document.getElementById('selectColor').addEventListener('click', changeBackgroundColor);
